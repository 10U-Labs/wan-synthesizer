...
- [Conventions](#conventions)
  - [An issue about anything else has two sections](#an-issue-about-anything-else-has-two-sections)
  - [Ask about a fork before the issue is filed](#ask-about-a-fork-before-the-issue-is-filed)
  - [Back a claim with a number from the repository own data](#back-a-claim-with-a-number-from-the-repository-own-data)
  - [Bullets enumerate, tables compare, an argument is prose](#bullets-enumerate-tables-compare-an-argument-is-prose)
  - [Name the closing section Proposed Solution](#name-the-closing-section-proposed-solution)
  - [Say what the thing is before naming it](#say-what-the-thing-is-before-naming-it)
  - [Simple English, one fact to a sentence](#simple-english-one-fact-to-a-sentence)
  - [Telecommunications vocabulary for the subject matter](#telecommunications-vocabulary-for-the-subject-matter)
  ...
  - [Which issues owe the four test sections](#which-issues-owe-the-four-test-sections)
    - [A program issue owes all six sections](#a-program-issue-owes-all-six-sections)
    - [Config, data and workflow issues owe none](#config-data-and-workflow-issues-owe-none)
    - [Machinery under test is program code](#machinery-under-test-is-program-code)
    - [The assertions themselves are not](#the-assertions-themselves-are-not)
    - [What the defect is in decides it](#what-the-defect-is-in-decides-it)
  - [Write each backward-looking section honestly](#write-each-backward-looking-section-honestly)
- [Notes](#notes)
...
### Back a claim with a number from the repository own data
...
### Bullets enumerate, tables compare, an argument is prose
...
### Name the closing section Proposed Solution
...
### Say what the thing is before naming it
...
### Simple English, one fact to a sentence
...
### Telecommunications vocabulary for the subject matter
...
#### A program issue owes all six sections
...
#### Config, data and workflow issues owe none
...
#### Machinery under test is program code
...
#### The assertions themselves are not
...
#### What the defect is in decides it
...
### Write each backward-looking section honestly
