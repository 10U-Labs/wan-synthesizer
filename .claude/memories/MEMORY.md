...
- [a-site-is-a-named-place-not-a-building](a-site-is-a-named-place-not-a-building.md) — a site is a tenant's named place with a coordinate and nothing smaller is modelled, so no building exists here; a carrier PoP is a PoP and a provider region is a region, never a site; the vertex the directive is proved over is a city, and the word to reach for instead of `building`
