...
_READER: dict[str, Any] = {
    "endpoint": "tenants",
    "stored_key": "tenants/f-35/knobs.json",
    "stored": {"backbone_coverage_target_miles": 745},
    "serve_event": {
        "pathParameters": {"tenant": "f-35"},
        "path": "/x/tenants/f-35/knobs",
    },
    "serve_expect": {"backbone_coverage_target_miles": 745},
    "unknown_event": {
        "pathParameters": {"tenant": "f-35"},
    ...
    "notbuilt_event": {
        ...
        "path": "/x/tenants/minuteman/knobs",
    },
}
...
def test_tenant_delete_leaves_no_delete_marker(monkeypatch: pytest.MonkeyPatch) -> None:
    module = _tenant(monkeypatch)
    fake = fake_s3({"tenants/f-35/locations.json": b"[]", "tenants/f-35/wan.json": b"{}"})
    event = {"httpMethod": "DELETE", "pathParameters": {"tenant": "f-35"}}
